# ADR: Vaded Gaming OSS Positioning — Portfolio + Reference Implementation
...
Vaded Gaming is positioned as a solo personal project that is open-source for learning and self-hosting — not an actively-maintained community project. Visitors should understand this immediately from the README.
...
3. **Added solo-maintenance paragraph to README** ("Maintenance model" under Why Vaded Gaming?) — sets accurate expectations upfront
...
Make Vaded Gaming private. Rejected: removes portfolio signal entirely; self-hosters lose access; no upside.
