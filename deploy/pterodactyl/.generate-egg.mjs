...
const egg = {
    ...
    variables: [
        ...
        v(
            'Lavalink Host',
            'Hostname of your Lavalink server (rainlink client). Left unset, the bot falls back to "localhost", which does not exist inside this container and makes music playback fail in a connection-refused retry loop — set this explicitly.',
            'LAVALINK_HOST',
            '',
            'required|string',
        ),
        ...
        v(
            'Lavalink Password',
            'Authentication password/token for your Lavalink server.',
            'LAVALINK_PASSWORD',
            '',
            'required|string',
            true,
        ...
        v(
            'Lavalink Secure (SSL)',
            'true if your Lavalink server is behind https/wss (e.g. port 443), false for a plain ws:// connection.',
            'LAVALINK_SECURE',
            'false',
