# Code Review Tooling — Vaded Gaming
...
| Trivy                                         | Container scanning; not yet relevant — Vaded Gaming deploys via Docker but Socket + GitHub Dependabot already handle node deps                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
3. **Flag silent failures** — "Flag empty catch blocks, swallowed promise
   ...
   them." (Recurring Vaded Gaming bug class — see issues #1159/#1160.)
