...
export default function ModerationFilterOptions({
    ...
    return (
        <div className='border-t border-vaded-border pt-4'>
            ...
            <div className='space-y-3 rounded-lg border border-vaded-border bg-vaded-bg-tertiary p-4'>
                {FILTER_OPTIONS.map(({ key, label, desc }) => (
                    <div
                        key={key}
                        className='flex flex-row items-center justify-between rounded-md bg-vaded-bg-secondary p-3'
                    >
