...
const SOURCES = [
    {
        ...
        // Spotify logo mark
        icon: (
            <svg role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' className='w-3 h-3 shrink-0' fill='currentColor' aria-hidden='true'>
    ...
    },
    {
        ...
        // SoundCloud cloud
        icon: (
            <svg role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' className='w-3.5 h-3.5 shrink-0' fill='currentColor' aria-hidden='true'>
                <path d='M1.175 12.225C.513 12.225 0 12.737 0 13.4v.effects0c0 .662.513 1.175 1.175 1.175s1.175-.513 1.175-1.175-.513-1.175-1.175-1.175zM3.78 11.4c-.363 0-.675.3-.675.675v2.65c0 .375.3.675.675.675s.675-.3.675-.675v-2.65c0-.375-.3-.675-.675-.675zm2.62-.263c-.375 0-.675.3-.675.675v3.175c0 .375.3.675.675.675s.675-.3.675-.675v-3.175c0-.375-.3-.675-.675-.675zm2.625-.375c-.375 0-.675.3-.675.675v3.55c0 .375.3.675.675.675s.675-.3.675-.675v-3.55c0-.375-.3-.675-.675-.675zm2.625.225c-.375 0-.675.3-.675.675v3.1c0 .375.3.675.675.675s.675-.3.675-.675v-3.1c0-.375-.3-.675-.675-.675zm2.625-.625c-.375 0-.675.3-.675.675v3.75c0 .375.3.675.675.675s.675-.3.675-.675v-3.75c0-.375-.3-.675-.675-.675zM18.9 9.8C18.2 8.1 16.5 6.9 14.55 6.9c-.45 0-.9.075-1.3.2C12.2 5.65 10.6 4.8 8.8 4.8c-3.05 0-5.525 2.475-5.525 5.525 0 .1.025.2.025.3C1.4 11.0.5 12.1.5 13.4v.05c0 1.575 1.275 2.85 2.85 2.85h15.55c1.575 0 2.85-1.275 2.85-2.85 0-1.425-1.025-2.6-2.4-2.825C19.325 10.275 19.125 10 18.9 9.8z'/>
            </svg>
        ),
    },
]
